...
const n_id = {data: ["im00", "im01", "im02", "im03", "im04", "im05", "im06", "im07", "im08", "im09"]};
const o_id = {data: ["im000", "im001", "im002", "im003", "im004", "im005", "im006"]};
...
function expand_image(obj) {
    ...
    obj.style.zIndex = 1;
    for(let obj of document.getElementsByClassName("scr-wind")) {
        obj.style.visibility = "hidden";
    }
    for(let obj of document.getElementsByClassName("scroll-butt")) {
        obj.style.visibility = "hidden";
    }
    global_l_butt.style.visibility = "visible";
    global_r_butt.style.visibility = "visible";
    obj.style.visibility = "visible";
    curr_showing_img = obj;
    for (let i = 0; i<curr_mem.data.length; i++) {
        if(curr_mem.data[i] == obj) {
            curr_mem.ptr = i;
        }
    }
